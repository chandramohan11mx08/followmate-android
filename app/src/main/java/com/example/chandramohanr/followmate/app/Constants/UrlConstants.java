...
public final class UrlConstants {
    ...
    private static String USER_REGISTER[] = {"http://192.168.1.100:6610/user/register", "http://localhost:6610/user/register"};

    private static String SERVER_SOCKET[] = {"http://192.168.1.100:6610", "http://localhost:6610/user/register"};
